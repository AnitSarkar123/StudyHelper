...
const distributeFAQContent = (state: typeof OverallState.State) => {
...
const aggregateFAQSummaries = async (state: typeof OverallState.State) => {
  return {
...
const mergeFAQBatches = async (state: typeof OverallState.State) => {
...
const graph = new StateGraph(OverallState)
  .addNode("createFAQChunks", createFAQChunks)
  .addNode("aggregateFAQSummaries", aggregateFAQSummaries)
  .addNode("mergeFAQBatches", mergeFAQBatches)
  .addNode("compileFAQ", compileFAQ)
  .addConditionalEdges("__start__", distributeFAQContent, ["createFAQChunks"])
  .addEdge("createFAQChunks", "aggregateFAQSummaries")
  .addConditionalEdges("aggregateFAQSummaries", needsFAQMerge, [
    "mergeFAQBatches",
    "compileFAQ",
  ])
  .addConditionalEdges("mergeFAQBatches", needsFAQMerge, [
    "mergeFAQBatches",
    "compileFAQ",
  ])
  .addEdge("compileFAQ", "__end__");
